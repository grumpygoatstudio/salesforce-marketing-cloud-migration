...
def active_campaign_sync():
    ...
    db.query("""SELECT  * FROM contacts_mv WHERE email_address != '' AND email_address != 'none' AND email_address IN (SELECT DISTINCT email FROM orders_mv WHERE venue_id in (%s));"""
    % venue_target)
